...
issue](https://github.com/cisagov/nvdsync-lambda-tf-module/issues) in this
...
request](https://github.com/cisagov/nvdsync-lambda-tf-module/pulls), you
...
```console
cd nvdsync-lambda-tf-module
pyenv virtualenv <python_version_to_use> nvdsync-lambda-tf-module
pyenv local nvdsync-lambda-tf-module
