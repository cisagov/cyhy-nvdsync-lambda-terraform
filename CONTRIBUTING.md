...
issue](https://github.com/cisagov/cyhy-nvdsync-lambda-terraform/issues) in this
...
request](https://github.com/cisagov/cyhy-nvdsync-lambda-terraform/pulls), you
...
```console
cd cyhy-nvdsync-lambda-terraform
pyenv virtualenv <python_version_to_use> cyhy-nvdsync-lambda-terraform
pyenv local cyhy-nvdsync-lambda-terraform
