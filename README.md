...
```hcl
module "example" {
  source = "github.com/cisagov/cyhy-nvdsync-lambda-terraform?ref=v1.1.0"
...
- [Basic usage](https://github.com/cisagov/cyhy-nvdsync-lambda-terraform/tree/develop/examples/basic_usage)
